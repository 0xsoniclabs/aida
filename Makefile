...
format:
	@goimports -w ./utils ./profile ./txcontext ./ethtest ./rpc ./tracer ./cmd/util-db/compact ./cmd/util-db/info ./cmd/util-db/compact
	@gofmt -s -d -w ./utils ./profile ./txcontext ./ethtest ./rpc ./cmd/util-db/compact ./cmd/util-db/info ./cmd/util-db/compact

check:
	@golangci-lint run -c .golangci.yml ./utils ./profile ./txcontext ./tracer ./ethtest ./rpc ./cmd/util-db/compact ./cmd/util-db/info ./cmd/util-db/compact

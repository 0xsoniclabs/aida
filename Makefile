...
format:
	@goimports -w ./utils ./profile ./txcontext ./ethtest ./rpc ./stochastic
	@gofmt -s -d -w ./utils ./profile ./txcontext ./ethtest ./rpc ./stochastic

check:
	@golangci-lint run -c .golangci.yml ./utils ./profile ./txcontext ./ethtest ./rpc ./stochastic

...
format:
	@goimports -w ./utils ./profile ./txcontext ./ethtest ./rpc ./tracer
	@gofmt -s -d -w ./utils ./profile ./txcontext ./ethtest ./rpc ./tracer

check:
	@golangci-lint run -c .golangci.yml ./utils ./profile ./txcontext ./ethtest ./rpc ./tracer

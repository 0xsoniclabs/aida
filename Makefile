...
format:
	@goimports -w ./utils ./profile ./txcontext ./ethtest ./rpc ./logger ./register
	@gofmt -s -d -w ./utils ./profile ./txcontext ./ethtest ./rpc ./logger ./register

check:
	@golangci-lint run -c .golangci.yml ./utils ./profile ./txcontext ./ethtest ./rpc ./logger ./register

...
format:
	@goimports -w ./utils ./profile ./txcontext ./ethtest ./rpc ./cmd/util-db/compact ./cmd/util-db/info ./cmd/util-db/compact ./stochastic
	@gofmt -s -d -w ./utils ./profile ./txcontext ./ethtest ./rpc ./cmd/util-db/compact ./cmd/util-db/info ./cmd/util-db/compact ./stochastic

check:
	@golangci-lint run -c .golangci.yml ./utils ./profile ./txcontext ./ethtest ./rpc ./cmd/util-db/compact ./cmd/util-db/info ./cmd/util-db/compact ./stochastic

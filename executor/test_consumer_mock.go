...
//
//	mockgen -source test_consumer.go -destination test_consumer_mock.go -package executor
//
...
import (
	...
	tracer "github.com/0xsoniclabs/aida/tracer"
...
// Consume mocks base method.
func (m *MockOperationConsumer) Consume(block, transaction int, operations tracer.Operation) error {
	m.ctrl.T.Helper()

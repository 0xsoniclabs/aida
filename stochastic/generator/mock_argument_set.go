...
func (m *MockArgumentSet) Choose(kind int) (ArgumentType, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArgumentSetMockRecorder) Choose(kind interface{}) *gomock.Call {
...
func (mr *MockArgumentSetMockRecorder) Remove(v interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

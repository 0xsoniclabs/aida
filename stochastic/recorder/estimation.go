...
// NewEstimationStats creates a new EstimationStatsJSON objects for an access classifier.
func NewEstimationStats(d *classifier.ArgClassifierJSON) EstimationStatsJSON {
	// compute lambda

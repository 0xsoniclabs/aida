...
// FindBlockRangeInBlockHash finds the first and last block in the block hash
func FindBlockRangeInBlockHash(db db.BaseDB, log logger.Logger) (uint64, uint64, error) {

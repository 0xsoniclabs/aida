...
## Overview
`util-updateset` is the UpdateSet Manager. It generates **[UpdateSets](Terminology)**—collections of state changes—used to efficiently 'prime' the world state at arbitrary block heights for fast replaying.

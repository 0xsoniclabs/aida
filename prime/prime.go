...
// setPrimeEnvironment is a precompute step calculating primable block and actual first block.
func (p *primer) setPrimeEnvironment(aidaDb db.BaseDB) {
	// set databases
